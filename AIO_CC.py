...
|____/_____|_| \_|  \_____|______|_| \_|
	...
	def cc_gen_random():
		print("""
  _____ _____    _____ ______ _   _   _____  _____  __  __ 
 / ____/ ____|  / ____|  ____| \ | | |  __ \|  __ \|  \/  |
| |   | |      | |  __| |__  |  \| | | |__) | |  | | \  / |
| |   | |      | | |_ |  __| | . ` | |  _  /| |  | | |\/| |
| |___| |____  | |__| | |____| |\  | | | \ \| |__| | |  | |
 \_____\_____|  \_____|______|_| \_| |_|  \_\_____/|_|  |_|
...
##########################################################################################################################################	
	def cc_gen_country():
		print("""
  _____ _____    _____ ______ _   _    _____ ____  _    _ _   _ _______ _______     __
 / ____/ ____|  / ____|  ____| \ | |  / ____/ __ \| |  | | \ | |__   __|  __ \ \   / /
| |   | |      | |  __| |__  |  \| | | |   | |  | | |  | |  \| |  | |  | |__) \ \_/ / 
| |   | |      | | |_ |  __| | . ` | | |   | |  | | |  | | . ` |  | |  |  _  / \   /  
| |___| |____  | |__| | |____| |\  | | |___| |__| | |__| | |\  |  | |  | | \ \  | |   
 \_____\_____|  \_____|______|_| \_|  \_____\____/ \____/|_| \_|  |_|  |_|  \_\ |_|   
...
\033[m30) Argentina                   \033[m60) Panama                \033[m90) Uruguay
	...
	def cc_gen_cardmarca():
		print("""
  _____ _____    _____ ______ _   _   ____  _____            _   _ _____  
 / ____/ ____|  / ____|  ____| \ | | |  _ \|  __ \     /\   | \ | |  __ \ 
| |   | |      | |  __| |__  |  \| | | |_) | |__) |   /  \  |  \| | |  | |
| |   | |      | | |_ |  __| | . ` | |  _ <|  _  /   / /\ \ | . ` | |  | |
| |___| |____  | |__| | |____| |\  | | |_) | | \ \  / ____ \| |\  | |__| |
 \_____\_____|  \_____|______|_| \_| |____/|_|  \_\/_/    \_\_| \_|_____/ 
...
\033[m10) CHINA UNION PAY             \033[m20) DUE             \033[m30)
	...
	def cc_gen_cardtype():		
		print("""
  _____ _____    _____ ______ _   _   _________     _______  ______ 
...
\033[m5) BANKCARD(INACTIVE) """)          
	...
	def get_info():
		...
		if decision == 1:
			...
			for linea in combo:
					datos = linea.split(':')
					r = requests.get("https://bin-checker.net/api/" + datos[0])
					json = r.json()
...
1.Generador BINS aleatorios
2.Generador CC'S aleatorias
3.Generar CC'S por pais (necesita conexion a internet)
4.Generar CC'S por marca de tarjeta (necesita conexion a internet)
5.Generar CC'S por tipo (necesita conexion a internet)
6.Generar CC'S por nivel (necesita conexion a internet)
7.Generar CC'S por pais, marca y tipo (necesita conexion a internet)
8.Obtener info de las CC'S y BINS (necesita conexion a internet)
""")
